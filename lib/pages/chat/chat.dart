...
class _ChatBotPageState extends State<ChatBotPage> {
  ...
  void _addWelcomeMessage() {
    final welcomeMessage = ChatMessage(
      text: "👋 Bonjour ! Je suis l'assistant PorcaManage. Je peux vous aider à enregistrer vos revenus, suivre vos dépenses, comprendre vos statistiques ou répondre à vos questions sur la gestion de votre budget. Comment puis-je vous aider aujourd'hui ?",
      isUser: false,
  ...
  Future<String> _getBotResponse(String message) async {
    ...
    try {
      // Préparer le prompt avec le contexte de PorcaManage
      final prompt = "Tu es PorcaManage Assistant, un chatbot utile et amical pour une application de gestion des revenus et dépenses appelée PorcaManage. "
          "L'application permet aux utilisateurs d'enregistrer leurs revenus, suivre leurs dépenses et mieux gérer leur budget. "
          "Réponds toujours en français. Sois concis, clair et motivant. "
      ...
      return response.text ??
          "Je comprends que vous dites: '$message'. En tant qu'assistant PorcaManage, je suis là pour vous aider à suivre vos finances. Voulez-vous enregistrer un revenu, une dépense ou consulter votre budget ?";
    } catch (e) {
      print("Erreur Firebase AI: $e");
      return "Merci pour votre message ! En tant qu'assistant PorcaManage, je peux vous aider à ajouter un revenu, noter une dépense ou comprendre vos statistiques financières. Que souhaitez-vous faire ?";
    }
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (context) => AlertDialog(
                      title: Text("À propos"),
                      content: Text("PorcaManage Assistant utilise Firebase AI avec le modèle Gemini pour répondre à vos questions sur notre application gestion de vos finances."),
                      actions: [
                        TextButton(
